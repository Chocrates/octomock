            ...
            constructor() {
                this.orgs = {
                    ...
                    listPendingInvitations:
                        mockFunctions.orgs.listPendingInvitations,
                    ...
                    addOrUpdateMembership:
                        mockFunctions.orgs.addOrUpdateMembership,
                    ...
                    checkPublicMembership:
                        mockFunctions.orgs.checkPublicMembership,
                ...
                this.repos = {
                    ...
                    getBranchProtection:
                        mockFunctions.repos.getBranchProtection,
                    updateBranchProtection:
                        mockFunctions.repos.updateBranchProtection,
                    removeBranchProtection:
                        mockFunctions.repos.removeBranchProtection,
                    ...
                    updateCommitComment:
                        mockFunctions.repos.updateCommitComment,
                    deleteCommitComment:
                        mockFunctions.repos.deleteCommitComment,
                    listCommits: mockFunctions.repos.listCommits,
                    listBranchesForHeadCommit:
                        mockFunctions.repos.listBranchesForHeadCommit,
                    listCommentsForCommit:
                        mockFunctions.repos.listCommentsForCommit,
                    createCommitComment:
                        mockFunctions.repos.createCommitComment,
                    ...
                    listDeploymentStatuses:
                        mockFunctions.repos.listDeploymentStatuses,
                    createDeploymentStatus:
                        mockFunctions.repos.createDeploymentStatus,
                    getDeploymentStatus:
                        mockFunctions.repos.getDeploymentStatus,
                    createDispatchEvent:
                        mockFunctions.repos.createDispatchEvent,
                    ...
                    getLatestPagesBuild:
                        mockFunctions.repos.getLatestPagesBuild,
                    ...
                    listAssetsForRelease:
                        mockFunctions.repos.listAssetsForRelease,
                    uploadReleaseAsset: mockFunctions.repos.uploadReleaseAsset,
                    getCodeFrequencyStats:
                        mockFunctions.repos.getCodeFrequencyStats,
                    getCommitActivityStats:
                        mockFunctions.repos.getCommitActivityStats,
                    getContributorsStats:
                        mockFunctions.repos.getContributorsStats,
                    getParticipationStats:
                        mockFunctions.repos.getParticipationStats,
                    ...
                    createUsingTemplate:
                        mockFunctions.repos.createUsingTemplate,
                ...
                this.issues = {
                    ...
                    listCommentsForRepo:
                        mockFunctions.issues.listCommentsForRepo,
                    ...
                    listEventsForTimeline:
                        mockFunctions.issues.listEventsForTimeline,
                    ...
                    listMilestonesForRepo:
                        mockFunctions.issues.listMilestonesForRepo,
                    ...
                    listLabelsForMilestone:
                        mockFunctions.issues.listLabelsForMilestone,
                    listForAuthenticatedUser:
                ...
                this.actions = {
                    ...
                    deleteSecretFromRepo:
                        mockFunctions.actions.deleteSecretFromRepo,
                    ...
                    getSelfHostedRunner:
                        mockFunctions.actions.getSelfHostedRunner,
                    ...
                    listArtifactsForRepo:
                        mockFunctions.actions.listArtifactsForRepo,
                    listDownloadsForSelfHostedRunnerApplication:
                        mockFunctions.actions
                            .listDownloadsForSelfHostedRunnerApplication,
                    listJobsForWorkflowRun:
                        mockFunctions.actions.listJobsForWorkflowRun,
                    listRepoWorkflowRuns:
                        mockFunctions.actions.listRepoWorkflowRuns,
                    listRepoWorkflows: mockFunctions.actions.listRepoWorkflows,
                    listSecretsForRepo:
                        mockFunctions.actions.listSecretsForRepo,
                    listSelfHostedRunnersForRepo:
                        mockFunctions.actions.listSelfHostedRunnersForRepo,
                    listWorkflowJobLogs:
                        mockFunctions.actions.listWorkflowJobLogs,
                    listWorkflowRunArtifacts:
                        mockFunctions.actions.listWorkflowRunArtifacts,
                    listWorkflowRunLogs:
                        mockFunctions.actions.listWorkflowRunLogs,
